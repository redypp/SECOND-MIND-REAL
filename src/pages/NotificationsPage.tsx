      ...
      {activeTab === 'inbox' ? (
        <div className="relative flex-1">
          ...
          <button
            ...
            className="fixed bottom-6 right-5 z-20 w-12 h-12 rounded-full bg-primary text-primary-foreground flex items-center justify-center shadow-lg shadow-primary/30 active:scale-95 transition-transform touch-manipulation"
            style={{ bottom: 'calc(var(--app-safe-bottom, 0px) + 24px)' }}
