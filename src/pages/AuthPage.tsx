...
/* ── Apple SVG ─────────────────────────────────────────────────────── */
/* Matched to Google's 18×18 footprint so the two OAuth buttons read evenly.
   The viewBox is squared and the path is centered; the previous icon used a
   17×20 viewBox at 16×19 px which made the symbol look squashed and clipped
   next to the Google logo. */
function AppleIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M17.05 12.04c-.03-2.85 2.33-4.22 2.44-4.29-1.33-1.95-3.4-2.21-4.13-2.24-1.76-.18-3.43 1.04-4.32 1.04-.89 0-2.27-1.01-3.73-.98-1.92.03-3.69 1.12-4.68 2.84-2 3.47-.51 8.6 1.43 11.42.95 1.38 2.08 2.93 3.57 2.87 1.43-.06 1.97-.93 3.7-.93 1.72 0 2.21.93 3.72.9 1.54-.03 2.51-1.4 3.45-2.79 1.09-1.6 1.54-3.15 1.56-3.23-.03-.02-3-.36-3.01-3.61zM14.7 4.04c.79-.96 1.32-2.29 1.18-3.62-1.14.05-2.52.76-3.34 1.71-.73.85-1.37 2.21-1.2 3.51 1.27.1 2.57-.65 3.36-1.6z"/>
    </svg>
  );
}
